...
public class MagicandSorcery {
    ...
    // Create a Deferred Register to hold Blocks which will all be registered under the "magicandsorcery" namespace
    public static final DeferredRegister.Blocks BLOCKS = DeferredRegister.createBlocks(MODID);
    // Create a Deferred Register to hold Items which will all be registered under the "magicandsorcery" namespace
    ...
    // Creates a new Block with the id "magicandsorcery:example_block", combining the namespace and path
    ...
    // Creates a creative tab with the id "magicandsorcery:example_tab" for the example item, that is placed after the combat tab
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> EXAMPLE_TAB = CREATIVE_MODE_TABS.register("example_tab", () -> CreativeModeTab.builder()
            .title(Component.translatable("itemGroup.magicandsorcery")) //The language key for the title of your CreativeModeTab
